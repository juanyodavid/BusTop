	...
	?>
		<div class="table-responsive">
			<table class="table table-striped table-hover">
				<thead>
					<tr>
						<th class='text-center'>Id destino </th>  
				...
				<tbody>	
						...
						<tr >
							...
							<td class='text-center'><?php   $query2 =mysqli_query($con,"SELECT  chapa FROM bus WHERE id_bus =".$asiento."");
          						...
          						?></td>
							<td class='text-center'><?php if ($estado==1) {
								$imp="Activo";}
								else{$imp="Expirado";}echo $imp;?></td>
							<td>
								
                                
								<a href="#"  data-target="#editProductModal" class="edit" data-toggle="modal" data-cliente_add="<?php echo $nombre;?>"data-ruci_add="<?php echo $ruci;?>"data-origen_add="<?php echo $observacion;?>"data-destino_add="<?php echo $origen;?>"data-asiento_add="<?php echo $destino;?>"data-vehi_add="<?php echo $asiento;?>"data-id="<?php echo $compra_id;?>">
