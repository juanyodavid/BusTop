<?php
	...
	$vehi = mysqli_real_escape_string($con,(strip_tags($_POST["vehi_edit"],ENT_QUOTES)));
	
	$id=intval($_POST['edit_id']);
	// UPDATE data into database
    $sql = "UPDATE destino SET destino='".$cliente."',rutas='".$ruci."',precio='".$origen."',salida_dia='".$destino."',salida_hora='".$asiento."',id_bus='".$vehi."'WHERE id_destino='".$id."' ";
