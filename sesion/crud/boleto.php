...
<body>
	...
	<!-- Edit Modal HTML -->
	<?php include("html/boleto_crud/modal_add.php");?>
	<!-- Edit Modal HTML -->
	<?php include("html/boleto_crud/modal_edit.php");?>
	<!-- Delete Modal HTML -->
	<?php include("html/boleto_crud/modal_delete.php");?>
	<script src="js/boleto_script.js"></script>
</body>
</html>