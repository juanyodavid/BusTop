				...
				<tbody>	
						...
						<tr >
							...
							<td>
								...
								<!-- <a href=""<?php if ($fecha==0) {  mysqli_query($con,"UPDATE `boleto` SET `estado`= 1 WHERE `id_destino`".$padre."");?>>
          						<i class="material-icons" data-toggle="submit" title="Confirmar boleto" >check</i><?php }?></a> -->

          						<a href="#"<?php if ($fecha==0) { echo'<script type="text/javascript"> alert("Tarea Guardada"); </script>';
?>>
          						<i class="material-icons" data-toggle="submit" title="Confirmar boleto" >check</i><?php }?></a>
								
								

								<a href="#"<?php if ($fecha==1){?>><i class="material-icons" data-toggle="submit" title="Confirmar boleto" >print</i><?php }?></a>
